...
// marketcap button event
document.getElementById('marketcap-btn').addEventListener('click', () => {
  record.sort((a, b) => b.total_volume - a.total_volume);
  renderTable(record);
  });

  // percentage change button event
document.getElementById('percentageSort-btn').addEventListener('click', () => {
  record.sort((a, b) => b.price_change_percentage_24h - a.price_change_percentage_24h);
  renderTable(record);
});